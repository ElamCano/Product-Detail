...
export default function ProductButtons({ max, resetCounter }) {
  ...
  return (
    <div className="flex mt-6 lg:mt-4">
      <div className="flex justify-around p-2 h-8 w-40 md:h-10 ml-2 md:ml-2 border border-gray-900 rounded-md">
        <img
          src="/minus.svg"
          alt="minus"
      ...
      <button
        ...
        } flex justify-center items-center p-2 h-8 w-full min-w-[180px]  max-w-[230px] lg:h-10 lg:w-[250px] ml-3 border transition duration-500 ease-in-out rounded-md text-white`}
      >
        {counter ? (
          <div className="flex">
